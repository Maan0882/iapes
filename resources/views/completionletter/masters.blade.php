        ...
        @foreach($offers as $offer)
            ...
            <main>
                ...
                <div class="content-p">
                    ...
                    He actively contributed to His Project F<strong>{{ $projectName }}</strong> and displayed a strong
                    willingness to learn and adapt to new challenges. His dedication and professionalism have
                    been commendable throughout the internship period.
                </div>

...
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap&family=Times+New+Roman,wght@0,400;0,700;1,400;1,700&display=swap');
